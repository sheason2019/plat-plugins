...
pub unsafe fn _export_on_init_cabi<T: Guest>() {
...
macro_rules! __export_world_identity_world_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[export_name = "on-init"]
    unsafe extern "C" fn export_on_init() {
      $($path_to_types)*::_export_on_init_cabi::<$ty>()
    }
  };);
}
#[doc(hidden)]
pub(crate) use __export_world_identity_world_cabi;
#[allow(dead_code)]
pub mod wasi {
    #[allow(dead_code)]
    pub mod cli {
...
macro_rules! __export_identity_world_impl {
  ($ty:ident) => (self::export!($ty with_types_in self););
  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
  $($path_to_types_root)*::__export_world_identity_world_cabi!($ty with_types_in $($path_to_types_root)*);
...
#[doc(inline)]
pub(crate) use __export_identity_world_impl as export;
...
\0\x0aresolution\x01\x02\x03\x01\x1cwasi:clocks/wall-clock@0.2.0\x05\x13\x01@\0\x01\
\0\x04\0\x07on-init\x01\x14\x02\x03\0\x08\x10incoming-request\x02\x03\0\x08\x11r\
