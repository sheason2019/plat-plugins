...
macro_rules! __export_utils_world_impl {
...
#[doc(inline)]
pub(crate) use __export_utils_world_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:utils-world:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7031] = *b"\
...
\x04\x01\x16plat:utils/utils-world\x04\0\x0b\x11\x01\0\x0butils-world\x03\0\0\0G\
